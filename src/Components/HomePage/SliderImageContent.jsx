...
export let SlideLeftBtn = ({ onClick }) => {
    return (
        <div className="slideLeftBtn homeSliderButton" id='prev' onClick={onClick}>
...
export let SlideRighttBtn = ({ onClick }) => {
    return (
        <div className={`slideRightBtn homeSliderButton`} id='next' onClick={onClick}>
