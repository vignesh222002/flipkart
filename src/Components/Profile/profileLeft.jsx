...
let ProfileNavLink = ({to, children, profileNavInitialActive, setProfileNavInitialActive}) => {
        ...
        <NavLink to={to} className='profileNavLink'>
            ...
            {({isActive}) => {
                isActive || profileNavInitialActive ? (
                    <div className="profileNavLinkActive">{children}</div>
                ) : (
                    <div>{children}</div>
                )
            }} */}
